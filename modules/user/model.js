app.factory('UserModel', ['$rootScope','UserService', function($rootScope,UserService) {
  return {
    ...
    _handleFindAllSuccess:function(result){
      $rootScope.$broadcast('user:find_all_success', result.data);
    },
    _handleFindAllError:function(error){
      $rootScope.$broadcast('user:find_all_error', error.data);
    ...
    _handleFindSuccess:function(result){
      $rootScope.$broadcast('user:find_success', result.data);
    },
    _handleFindError:function(error){
      $rootScope.$broadcast('user:find_error', error.data);
    ...
    _handleCreateSuccess:function(result){
      $rootScope.$broadcast('user:create_success', result.data);
    },
    _handleCreateError:function(error){
      $rootScope.$broadcast('user:create_error', error.data);
    ...
    _handleUpdateSuccess:function(result){
      $rootScope.$broadcast('user:update_success', result.data);
    },
    _handleUpdateError:function(error){
      $rootScope.$broadcast('user:update_error', error.data);
    ...
    _handleRemoveSuccess:function(result){
      $rootScope.$broadcast('user:remove_success', result.data);
    },
    _handleRemoveError:function(error){
      $rootScope.$broadcast('user:remove_error', error.data);
